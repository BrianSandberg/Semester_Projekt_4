        ...
        try:
            ...
            if gameId in games:
                ...
                if not data:
                    ...
                    if data == "reset":
                        game.resetWent()
                    #"get" sends the game to the client - Is sent every frame
                    elif data != "get":
                        game.play(p, data)
                    #Last is "move" -  The client sends the move to the server, which updates the game and sends it to client
